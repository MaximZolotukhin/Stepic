...
numbers = [float(num) for num in input().split()] # Делаю список из вещественных чисел
words = [*input().split()] # Делаю список из названий городов

lst = [*numbers, *words] # Распаковываю в один список сначала числа, потом города
print(*lst)
